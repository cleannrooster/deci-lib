...
public class ArcaneBipedRenderer extends HumanoidRenderer<DataDrivenMob> {

    public ArcaneBipedRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, HumanoidMobModel.LAYER, AnimationStyle.LIGHT, 0.9f);
    }
}
