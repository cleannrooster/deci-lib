...
public class SwiftQuadrupedRenderer extends QuadrupedRenderer<DataDrivenMob,QuadrupedMobModel<DataDrivenMob>> {

    public SwiftQuadrupedRenderer(EntityRendererFactory.Context ctx) {
