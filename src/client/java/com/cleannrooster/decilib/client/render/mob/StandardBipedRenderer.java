...
public class StandardBipedRenderer extends HumanoidRenderer<DataDrivenMob> {

    public StandardBipedRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, HumanoidMobModel.LAYER, AnimationStyle.HEAVY, 1.05f);
    }
}
