...
public class StandardQuadrupedRenderer extends QuadrupedRenderer<DataDrivenMob,QuadrupedMobModel<DataDrivenMob>> {

    public StandardQuadrupedRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, new QuadrupedMobModel<>(ctx.getPart(QuadrupedMobModel.LAYER), AnimationProfile.of(AnimationStyle.LIGHT)),1.0F);
    }
}
