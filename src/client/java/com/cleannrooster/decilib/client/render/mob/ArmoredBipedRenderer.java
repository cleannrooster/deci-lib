...
public class ArmoredBipedRenderer extends HumanoidRenderer<DataDrivenMob> {

    public ArmoredBipedRenderer(EntityRendererFactory.Context ctx) {
        super(ctx, HumanoidMobModel.LAYER, AnimationStyle.HEAVY, 1.1f);
    }
}
